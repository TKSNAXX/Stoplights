...
class IntersectionVarsDialog(Dialog):
    ...
    def __init__(
        ...
        self._paint_label = ParamLabel("Thru Lines")
    ...
    def _sync_thru_switch(self) -> None:
        ...
        self._paint_switch.enabled = allowed
        if not allowed:
            self._paint_switch.value = False
